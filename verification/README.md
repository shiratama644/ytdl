...
## 第 6 回: ユーザー側で実行していただくもの(1 回 ~10 秒・probe 数秒)
...
1. [v1f-gas-test.gs (raw)](https://raw.githubusercontent.com/shiratama644/ytdl/arena/01a094ec-ytdl/verification/v1f-gas-test.gs)
   を開いて中身を**全てコピー**
