...
| [`VERIFICATION_P0.md`](./VERIFICATION_P0.md) | P0 検証証跡(2026-09-12〜)。**V1〜V6**(V1〜V4 = 旧 GAS 期の実施記録 = サンドボックス + ユーザー実行。V1-d の `/watch/` 抽出アルゴリズムはサーバー実装へ継承)/ **V5(ブラウザ側 iframe 到達性)・V6(サーバー側メタデータ取得)= 実行待ち**(2026-09-23 追加)。**設計への影響**表と観察 O1〜O9 を含む |
